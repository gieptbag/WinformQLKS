...
namespace QLKHACHSAN.GUI
{
    public partial class frm_QLDatphong : Form
    {
        ...
        public static int ktmadatphong(string madp)
        {
            ...
            con.ConnectionString = @"Data Source=MSI\SQLEXPRESS;Initial Catalog=QLKS;Integrated Security=True";
        ...
        private void dp_datetp_ValueChanged(object sender, EventArgs e)
        {
